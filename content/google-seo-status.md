...
| 租車取車還車文章 | `Google 無法辨識的網址`，Search Console 尚未回報 sitemap | 公開頁面、canonical 與 sitemap 已驗證正常，屬於 Search Console 資料尚未更新 | 2026-07-24 已要求建立索引；7–14 天後複查 |
| 國際通親子文章 | `Google 無法辨識的網址`，Search Console 尚未回報 sitemap | 公開頁面、canonical 與 sitemap 已驗證正常，屬於 Search Console 資料尚未更新 | 2026-07-24 已要求建立索引；7–14 天後複查 |

以上四個新網址的申請畫面都已確認顯示「已將網址加入優先檢索佇列」。這只代表要求送出，不代表當天就會收錄。
