...
const source = new URL("./souvenir-customs.html", import.meta.url).href;
const preview = path.join(os.tmpdir(), "okinawa-souvenir-customs-preview.png");
const output = path.resolve(
  here,
  "../../public/images/articles/okinawa-souvenir-customs-taiwan/customs-compare.jpg",
);
