...
$final = Join-Path $output 'okinawa-kouri-nago-choice-reel-v1.mp4'
...
[1:a]adelay=120|120,highpass=f=90,lowpass=f=12000,loudnorm=I=-16:TP=-1.5:LRA=7,apad=pad_dur=15[voice];
[2:a]atrim=0:15,afade=t=in:st=0:d=0.3,afade=t=out:st=14.2:d=0.8,volume=0.06[music];
