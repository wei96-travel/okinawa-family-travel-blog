...
- 2026-08-06 Okinawa World / Gyokusendo photo update (wei96-approved, in progress): user reported completing their own check and explicitly approved public use of the original photos to improve the article. Codex has selected only photo 13 (entrance), 15 (Iwayado-no-O), 16 (Ao-no-Izumi) and 17 (cave water scene); photo 18 is excluded because visitors are identifiable. The existing article will keep its decision graphic, add the four photos and apply the established download deterrence. Codex owns the article, its four image assets, the photo-plan/content-plan changes and this handoff entry until final verification; do not stage unrelated dirty files.
