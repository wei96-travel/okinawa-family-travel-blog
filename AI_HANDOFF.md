...
- 2026-08-06 DMM publication approval (wei96, in progress): the user explicitly approved publication of the reviewed DMM Kariyushi Aquarium article and clarified that its photos may also be published after checking the applicable information online. Codex recovered the original 22-photo attachment set from the prior conversation record. For this article, use only photos 10 (stingray cover), 2 (crab after cropping out the upper reflections), 8 (otter mousse) and 14 (sloth); photo 1 is excluded because visitors are identifiable, and photo 11 is excluded for image quality. **Photo rule:** crop out every identifiable face; if a composition cannot avoid faces, exclude that photo rather than blur it or publish it. Codex owns the public article, its four image assets, the DMM plan update and this handoff entry until the publication checks are complete.

- 2026-08-06 DMM publication run (Codex, ready to commit): refreshed the DMM Kariyushi Aquarium article against current official sources; its new public page is `content/blog/dmm-kariyushi-aquarium-family-guide.md`, with natural links to the existing Naha rainy-day, airport-to-city and Churaumi-duration guides. After the morning draft review, wei96 explicitly approved publication and the selected original photos. Three review passes completed: intent and scope clear; current official ticket, facility, access, cafe, operating and photo-use information verified; every used image was manually checked for identifiable faces; strict audit passed (48 articles, 0 critical issues; 37 pre-existing style reminders, none from the new article) and `next build` passed (73 static pages). No Klook change or social content was created. Commit only the DMM article, its three image assets, its plan / photo-plan / handoff records; do not stage the already-dirty daily schedule or social files. After push, verify the public HTTPS article at 390px and request Search Console indexing once only if production verification passes.
