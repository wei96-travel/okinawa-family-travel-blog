...
- Active Codex task: user-authorized Trip.com affiliate additions are in progress for `/blog/okinawa-churaumi-nearby-family-stay`; this does not alter its title, description, URL or primary advice. Observe the page after 2026-08-26; keep the Churaumi ticket guide in its 7–14-day observation window. Both new carousel sets remain unpublished because the required in-app Facebook session needs the user to sign in before release.
...
- Codex files currently claimed: `content/blog/okinawa-churaumi-nearby-family-stay.md`, `work/social/okinawa-last-day-family-plan/copy-facebook-long-form-2026-07-27.md`, `work/social/okinawa-family-restaurant-dining-guide/copy-facebook-long-form-2026-07-28.md`, `100_Todo/plans/2026-08-01-weekly-review.md`, `content/content-plan.md`, and this handoff.
