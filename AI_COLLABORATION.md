...
- **Article approval gate:** Every new blog article and every substantial rewrite must first be shown to the user as a complete draft or verified preview. Do not move it into the public publishing flow, commit it as a live article, push it for deployment, or request Google indexing until the user has reviewed that exact version and explicitly said it may be published. Silence, an earlier approval, or an automation schedule does not count as approval for a new version.
