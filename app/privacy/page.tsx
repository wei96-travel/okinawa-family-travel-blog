  ...
  return (
    <section className="mx-auto max-w-3xl px-5 py-12 sm:px-6 lg:px-8">
      ...
      <div className="prose-travel mt-8">
        <p>最後更新日期：2026 年 9 月 25 日</p>
        <p>
          本網站重視你的隱私。當你瀏覽本站時，網站分析工具可能記錄頁面瀏覽量、使用裝置、來源管道與頁面互動情形。本站只用這些資料改善內容與操作體驗，不會用來辨識你的個人身分。
        </p>
        <h2>Cookie 與分析工具</h2>
        <p>
          本站使用 Google Analytics 4 分析整體瀏覽狀況，也使用 Microsoft Clarity 了解頁面點擊、捲動深度、熱度圖與經遮罩處理的工作階段錄影。這些工具可能透過 Cookie 收集裝置、瀏覽頁面、停留時間、來源管道與頁面互動等資訊，用來改善內容、表單位置與閱讀體驗。
        </p>
        <p>
          Microsoft Clarity 預設會遮罩敏感內容；本站不會刻意將你在表單中輸入的 Email 或其他個人資料提供給分析工具。你可以透過瀏覽器設定限制或刪除 Cookie。
        </p>
        <h2>廣告</h2>
        <p>
